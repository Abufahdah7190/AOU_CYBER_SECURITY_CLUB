...
window.LOCALES = {
  "ar": {
    ...
    "auth": {
      ...
      "loginHelp": "تواجه مشكلة في تسجيل الدخول؟",
      "loginHelpLink": "أرسل لنا طلباً عبر صفحة الاقتراحات والشكاوى لمساعدتك.",
  ...
  "en": {
    ...
    "auth": {
      ...
      "loginHelpLink": "Send us a request via the Suggestions & Complaints page for help.",
